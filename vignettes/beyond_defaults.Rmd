...
```{r, dev = "png"}
#| fig.alt: > plot of population trajectories with three different initial conditions
...
```{r, dev = "png"}
#| fig.alt: > plot of population trajectories with the same initial condition
...
```{r, dev = "png"}
#| fig.alt: > plot of population trajectories with stochastic initial conditions
