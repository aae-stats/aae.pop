...
Simulated trajectories are arrays with dimensions of replicates (rows) by classes (columns) by time steps (slices). These arrays are relatively easy to summarise using `apply` functions but the `aae.pop` package includes several basic summary functions for convencience.
