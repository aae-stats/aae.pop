...
Simulated trajectories can be plotted using the standard `plot` function in R. This example sets the colour to a medium shade of blue with 90% transparency:
