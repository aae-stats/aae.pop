...
rates, but with a different covariate value for each replicate (i.e.,
each value of `nsim` in
...
except that it allows for a different value of the covariate applied to
each replicate trajectory. This specification can incorporate complex
structures, such as temporal dynamics in environmental stochasticity and
correlated uncertainty in vital rates.
